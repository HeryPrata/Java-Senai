  ...
  Scanner scan = new Scanner(System.in);
        ...
        while (opcao != 0) {
            ...
            switch (opcao) {
                ...
                case 1:
                    // Conta agora é abstrata. Menu alterado conforme o Exercício 3 da imagem image_093842.png
                    ...
                    // Cria o objeto Cliente necessário para o construtor das sub-contas
                    ...
                    if (tipo == 1) {
                        ...
                        c = new ContaEspecial(contadorNumeroConta, cliente, saldo, limite);
                    } else {
                        c = new ContaPoupanca(contadorNumeroConta, cliente, saldo);
                    }
                ...
                case 2:
                    ...
                    for (Conta conta : lista) {
                        ...
                        if (conta.getNumero() == numeroConsulta) {
                            // Busca o nome do titular a partir da associação com a classe Cliente
